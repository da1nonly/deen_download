...
class DLM_Download {
	 ...
	 * @return void
	 */
	public function get_the_file_title() {
	$version_post = get_post( $this->version_id );
		return $version_post->post_title;
	}
	 ...
	 * @return void
	 */
	public function the_file_title() {
		echo $this->get_the_file_title();
	}
	//
