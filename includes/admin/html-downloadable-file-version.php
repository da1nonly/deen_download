<div class="dlm-metabox closed downloadable_file" data-file="<?php echo $file_id; ?>">
	<h3>
		...
		<strong><?php echo sprintf( __( '<span class="version">%s</span> %s', 'download-monitor' ), ( $file_name ) ? $file_name : __('n/a', 'download-monitor'), date_i18n() ); ?> &mdash; <?php echo sprintf( _n('%s count', '%s count', $file_download_count, 'download-monitor'), $file_download_count ); ?></strong>
	...
	<table cellpadding="0" cellspacing="0" class="dlm-metabox-content">
		...
		<tr>
				<td width="1%">
					<label><?php _e( 'Number', 'download-monitor' ); ?>:</label>
			...
			<tr>
				<td>
					...
					<input type="text" class="short" name="downloadable_file_duration[<?php echo $i; ?>]" placeholder="<?php _e( 'n/a', 'download_monitor' ); ?>" value="<?php if(isset($file_duration)){echo $file_duration; }?>" />
				</td>
			...
			<tr>
				<td>
					<label><?php _e( 'File Type', 'download-monitor' ); ?>:</label>
					<input type="text" class="short" name="downloadable_file_type[<?php echo $i; ?>]" placeholder="<?php echo $file_type; ?>" />
				</td>
			</tr>
			<tr>
				<td>
